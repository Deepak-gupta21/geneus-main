        ...
        <MDBCol col='12'>
          ...
          <MDBCard className='bg-white my-4 mx-auto' style={{borderRadius: '1rem', maxWidth: '450px'}}>
            <MDBCardBody className='p-5 w-100 d-flex flex-column'>
              ...
              <MDBBtn className="mb-4 w-100" size="lg" style={{backgroundColor: '#dd4b39'}}>
              ...
              <MDBBtn className="mb-4 w-100 fw-bold" size='lg' >
                Log in
              </MDBBtn>

              <hr className="my-4 text-muted" />
              <p className="text-center text-body">Don't have an account? <a href="#!">Sign Up</a></p>
